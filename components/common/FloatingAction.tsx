...
export const FloatingAction = () => {
  ...
  const preFilledMessage = encodeURIComponent("Hello Ezadi Interior, I'd like to reach out regarding a project.");
  ...
  return (
    <div className="fixed bottom-6 right-6 md:bottom-10 md:right-10 z-50 flex flex-col items-center gap-4">
      ...
      <motion.a
        ...
        whileHover={{ scale: 1.1 }}
        whileTap={{ scale: 0.95 }}
        className="w-14 h-14 bg-[#25D366] text-white shadow-xl shadow-[#25D366]/20 rounded-full flex items-center justify-center hover:bg-[#128C7E] transition-colors"
