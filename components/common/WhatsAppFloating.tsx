...
export const WhatsAppFloating = () => {
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.9 }}
      className="fixed bottom-8 right-8 z-100 flex items-center justify-center w-14 h-14 bg-[#25D366] text-white rounded-full shadow-2xl transition-shadow hover:shadow-[0_0_25px_rgba(37,211,102,0.6)] group"
