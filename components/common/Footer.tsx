          ...
          <div className="lg:w-1/3 space-y-10">
            ...
            <div className="space-y-2 pt-4">
                <div className="flex items-center gap-4 pt-2">
                  <a href={`tel:${CONTACT.phone.replace(/\s+/g, '')}`} className="text-xl font-serif hover:text-accent transition-colors duration-300">
                    {CONTACT.phone}
                  </a>
                  <a 
                    ...
                    className="flex items-center justify-center w-8 h-8 rounded-full bg-[#25D366] text-white shadow-lg hover:scale-110 transition-transform"
                    aria-label="WhatsApp"
                  >
