...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    description: 'Seeking luxury interior design in Vijay Nagar, Indore? Discover how the best architect in Indore is redefining residential aesthetics through curated narratives.',
    category: 'Luxury',
    date: 'April 08, 2024',
    author: 'Salman Ansari',
    coverImage: 'https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?q=80&w=2000&auto=format&fit=crop',
    keywords: ['Luxury Interior Design Vijay Nagar', 'Indore High-End Homes', 'Spatial Orchestration', 'Best Architect in Indore'],
    content: `Vijay Nagar has evolved into a laboratory for high-end residential experimentation. The trend is moving away from superficial ornamentation toward a deep phenomenology of space. Homeowners are seeking environments that breathe—where light, shadow, and materiality perform a silent dance of elegance.`
  },
  {
    id: '3',
